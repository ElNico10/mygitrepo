/*
 ...
 - Random access is O(n) complexity, which makes getting random commands for the game
   less efficient compared to an array where random access is O(1). But for our
   use case with not a large amount of commands its ok.
 */
